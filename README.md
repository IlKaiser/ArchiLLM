...
- You can download the Archi Dataset from this [link](). Use these projects to test the system.
...
- Results of the automated evaluation of ArchiGPT are available [here](Metrics/src_metrics/be_node/src/data):
    ...
    Metrics are computed based on `data_metrics.json` in the [dataset](). An example of `data_metrics.json` is:
    ```
    [
        {
            "set_id": 1,
